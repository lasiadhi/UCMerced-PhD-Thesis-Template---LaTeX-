...
\title{Investigation on an Alien World}
...
\numberofmembers{3} % |chair|  + |othermembers| (do not count co-chair) % change here

\chair{Professor First Name Last Name}
% Uncomment the next line iff you have a Co-Chair
%\cochair{Professor Cochair Semimaster} 

\memberone{Professor First Name Last Name 1}
\membertwo{Professor First Name Last Name 2}
